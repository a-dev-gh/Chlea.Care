...
export const SEED_BRANDS = [
  { name: 'Davines',           slug: 'davines',           tagline: 'Belleza sostenible de Italia' },
  { name: 'Alfaparf Milano',   slug: 'alfaparf-milano',   tagline: 'Profesional italiano de alto rendimiento' },
  { name: 'Lola Cosmetics',    slug: 'lola-cosmetics',    tagline: 'Cuidado capilar brasileño' },
  { name: 'Boe Cosmetics',     slug: 'boe-cosmetics',     tagline: 'Tratamientos capilares especializados' },
  { name: 'Salerm Cosmetics',  slug: 'salerm-cosmetics',  tagline: 'Cosmética profesional española' },
  { name: 'Mielle Organics',   slug: 'mielle-organics',   tagline: 'Natural y orgánico para rizos' },
  { name: 'Agua de Cielo',     slug: 'agua-de-cielo',     tagline: 'Fragancias dominicanas' },
  { name: 'Difeel',            slug: 'difeel',            tagline: 'Aceites naturales para el cabello' },
  { name: 'OGX',               slug: 'ogx',               tagline: 'Belleza inspirada en la naturaleza' },
  { name: 'Got2b Glued',       slug: 'got2b-glued',       tagline: 'Fijación de alto impacto' },
  { name: 'Tree Hut',          slug: 'tree-hut',          tagline: 'Body care natural y delicioso' },
  { name: 'Skala Expert',      slug: 'skala-expert',      tagline: 'Cuidado capilar accesible' },
  { name: 'Endoten Control',   slug: 'endoten-control',   tagline: 'Control capilar profesional' },
  { name: 'The Ordinary',      slug: 'the-ordinary',      tagline: 'Skincare clínico sin complicaciones' },
  { name: 'Dove',              slug: 'dove',              tagline: 'Belleza real, cuidado real' },
  { name: 'Karseell',          slug: 'karseell',          tagline: 'Reparación con colágeno' },
