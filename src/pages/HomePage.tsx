  ...
  return (
    <div>
      ...
      {[
        {
          label: 'CABELLO',
          title: 'Cuida tu cabello\ncon lo mejor',
          body: 'Descubre las mejores marcas profesionales para nutrir, reparar y transformar tu cabello. Desde mascarillas hasta tratamientos de salón, todo en un solo lugar.',
          cta: 'Ver productos de cabello',
        ...
        },
        {
          label: 'SKINCARE',
          title: 'Tu piel\nmerece más',
          body: 'Exfoliantes, sérums, hidratantes y body care de marcas premium. Cuida tu piel con productos que realmente funcionan y te hacen brillar.',
          cta: 'Ver productos de skincare',
